...
export default function LostItemCard({
    ...
    return (
        <div id={item._id.toString()} className="transition-all border border-gray-200 bg-buzz-gold shadow hover:shadow-lg hover:-translate-y-0.5 rounded-xl w-full">
            <Image
            ...
            <div className="w-full p-3">
                ...
                {includeMapLink && (
                    <a href={"map?itemId=" + item._id}>
                        <button className="bg-buzz-blue text-white rounded-md px-2 py-1 hover:bg-buzz-blue/80 mt-3">
                            View on Map
                        </button>
                    </a>
                )}
