    ...
    <footer className="bg-gray-800 px-8 py-8">
      <div className="flex flex-row justify-center gap-20">
        ...
        <div className="text-center">
          <h2 className="text-4xl font-bold mb-4 text-[#EFBF04]">About Us</h2>
          <p className="text-white max-w-md text-xl">
            BuzzFinder behaves like an online lost and found service, enabling
            fellow Georgia Tech students to easily report and locate lost
            possessions.
          </p>
        </div>
        ...
        {/*Follow Us*/}
        <div className="text-center">
          <h2 className="text-4xl font-bold mb-6 text-[#EFBF04]">Follow Us</h2>
        ...
        <div className="text-center">
          ...
          <ul className="text-[#EFBF04] space-y-1 underline text-xs">
            <li>
              <a className="hover:text-blue-400 underline" href="">
                Dashboard
              </a>
            </li>
            <li>
      ...
      <div className="border-t border-gray-400 pt-6 text-gray-400 text-center mt-6">
        <img className="mx-auto" src="/buzzfinder-logo.png" alt="BuzzFinder" />
        <p className="mt-6">© 2025 BuzzFinder. All rights reserved.</p>
      </div>
    </footer>
  );
};
