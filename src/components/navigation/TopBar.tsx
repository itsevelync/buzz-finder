        ...
        <div className='flex w-full h-14 justify-between items-center border-b border-b-gray-300 py-3 px-5 bg-white'>
            ...
            <div className="flex items-center gap-2">
                <div className="relative group">
                    ...
                    {/* Tooltip */}
                    <span className="tooltip tooltip-bottom">{session?.user?.name ?? "Guest"}</span>
                </div>
                <NavItem name="Settings" href="/settings" icon={IoSettingsOutline} iconFill={IoSettings} direction="bottom" />
            </div>
        </div>
    );
};
